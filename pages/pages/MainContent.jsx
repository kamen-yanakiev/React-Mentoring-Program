...
import {
    moviesDataSelector, loadingSelector, errorSelector, sortBySelector, filterBySelector,
} from '../context/movies/selectors';

function sortMovies(sortType, stateMoviesData) {
    switch (sortType) {
    case sortTypes.RELEASE_DATE:
        return stateMoviesData.sort((a, b) => new Date(a.Released) - new Date(b.Released));
    ...
    case sortTypes.ALPHABETICALLY:
        return stateMoviesData.sort((a, b) => a.Title.localeCompare(b.Title));
    default:
